...
public class PuzzleSolver
{
    ...
    public IEnumerable<string> Solutions(string puzzle)
    {
        ...
        if (puzzle.Length != 81) throw new ArgumentException("Dane wejsciowe maja nieprawidlowa dlugosc.");
        if (_dlx == null) Build();
        ...
        for (var i = 0; i < puzzle.Length; i++)
        {
            ...
            if (puzzle[i] < '1' && puzzle[i] > '9')
                throw new ArgumentException($"Dane wejsciowe zawieraja nieprawidlowy znak: ({puzzle[i]})");
