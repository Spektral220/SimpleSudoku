...
public partial class GameView : UserControl
{
    ...
    public GameView(Level level)
    {
        ...
        if (board == null)
        {
            WarningTextBlock.Text = "Wystapil nieoczekiwany blad";
            return;
        }
        ...
        {
            WarningTextBlock.Text = "Nie udalo sie zaladowac zadania";
            return;
        }
    ...
    private void GameOverIfNeed()
    {
        ...
        if (!GameStateHolder.GetGameState().IsPuzzleSolved())
            WarningTextBlock.Text = "Gratulacje";
        if (GameStateHolder.GetGameState().IsLivesEmpty())
            WarningTextBlock.Text = "No i lipa :(";
